...
function SignupPage() {
  ...
  const termsContent = (
    <div>
      ...
      <p>Bienvenue sur DentAI - Centre Dentaire Bakraoui. En utilisant cette plateforme, vous acceptez de respecter les règles et conditions suivantes...</p>
      <ul>
  ...
  const privacyContent = (
    <div>
      ...
      <p>Vos données sont protégées et utilisées uniquement dans le cadre de votre activité au Centre Dentaire Bakraoui...</p>
      <ul>
      ...
      <div className="auth-branding">
        <div className="branding-content">
          ...
          <p>
            ...
            d'intelligence artificielle conçus pour les dentistes.
          </p>
        ...
        <div className="branding-footer">
          <p>© 2026 Centre Dentaire Bakraoui - Tous droits réservés</p>
        </div>
      </div>
                ...
                <div className="form-group">
                  ...
                  <div className="input-with-icon">
                    ...
                    <input
                      ...
                      name="email"
                      type="email"
                      placeholder="docteur@cdbakraoui.ma"
