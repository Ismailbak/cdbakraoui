...
const DIAGNOSIS_OPTIONS = [
  ...
  { value: 'Parodontite', label: 'Parodontite' },
  { value: 'Malocclusion', label: 'Malocclusion' },
  { value: 'Gingivite', label: 'Gingivite' },
  { value: 'Pulpite', label: 'Pulpite' },
  { value: 'Abcès dentaire', label: 'Abcès dentaire' },
  { value: 'Bruxisme', label: 'Bruxisme' },
  { value: 'Edentement', label: 'Edentement' },
  { value: 'Autre', label: 'Autre' },
];
