...
import {
  ...
  createFormDentExam, updateFormDentExam,
  createFormDentSoin, updateFormDentSoin,
  createFormDentEndo, updateFormDentEndo,
  createFormDentExtraction, updateFormDentExtraction,
  createFormDentProthese, updateFormDentProthese,
  createFormDentParo, updateFormDentParo,
  createFormDentPlan, updateFormDentPlan,
...
} from '../../components/MedicalForms/DentalForms';
...
const DENTAL_TREATMENTS = [
  {
    ...
    items: ["Paracétamol", "Ibuprofène", "Néfopam"]
  },
  {
    category: "Antibiotiques",
    items: ["Amoxicilline", "Amoxicilline + Acide clavulanique", "Métronidazole", "Clindamycine"]
  },
  {
    category: "Antiseptiques",
    items: ["Bain de bouche chlorhexidine", "Povidone iodée"]
  },
  {
    category: "Soins conservateurs",
    items: ["Composite", "Amalgame", "Ciment verre ionomère", "Scellement de sillons"]
  },
  {
    category: "Endodontie",
    items: ["Dévitalisation", "Retraitement endodontique", "Apexification"]
  },
  {
    category: "Chirurgie",
    items: ["Extraction simple", "Extraction chirurgicale", "Avulsion dent de sagesse"]
  },
  {
    category: "Prothèse",
    items: ["Couronne", "Bridge", "Prothèse amovible", "Facette"]
  },
  {
    category: "Parodontologie",
    items: ["Détartrage", "Surfaçage radiculaire", "Greffe gingivale"]
  }
];
...
const FORM_API_MAP = {
  'form_dent_exam': 'dent-exam',
  'form_dent_soin': 'dent-soin',
  'form_dent_endo': 'dent-endo',
  'form_dent_extraction': 'dent-extraction',
  'form_dent_prothese': 'dent-prothese',
  'form_dent_paro': 'dent-paro',
  'form_dent_plan': 'dent-plan',
};

const FORM_CRUD_MAP = {
  'form_dent_exam': { create: createFormDentExam, update: updateFormDentExam },
  'form_dent_soin': { create: createFormDentSoin, update: updateFormDentSoin },
  'form_dent_endo': { create: createFormDentEndo, update: updateFormDentEndo },
  'form_dent_extraction': { create: createFormDentExtraction, update: updateFormDentExtraction },
  'form_dent_prothese': { create: createFormDentProthese, update: updateFormDentProthese },
  'form_dent_paro': { create: createFormDentParo, update: updateFormDentParo },
  'form_dent_plan': { create: createFormDentPlan, update: updateFormDentPlan },
};
          ...
          <div className="maf-section">
            ...
            <div className="maf-field">
              ...
              <input
                ...
                placeholder="Ex: Caries profonde, Parodontite"
                ...
                <div className="maf-grid-2" style={{ gap: '15px' }}>
                  ...
                  <div className="maf-field">
                    ...
                    >
                      ...
                      {selectedFamily && DENTAL_TREATMENTS.find(g => g.category === selectedFamily)?.items.map(item => (
