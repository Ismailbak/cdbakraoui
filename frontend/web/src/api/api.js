...
// Form Data CRUD - dental forms (Centre Dentaire Bakraoui)
export const createFormDentExam = (data) => api.post('/forms/dent-exam', data);
export const getFormDentExam = (formId) => api.get(`/forms/dent-exam/${formId}`);
export const updateFormDentExam = (formId, data) => api.patch(`/forms/dent-exam/${formId}`, data);

export const createFormDentSoin = (data) => api.post('/forms/dent-soin', data);
export const getFormDentSoin = (formId) => api.get(`/forms/dent-soin/${formId}`);
export const updateFormDentSoin = (formId, data) => api.patch(`/forms/dent-soin/${formId}`, data);

export const createFormDentEndo = (data) => api.post('/forms/dent-endo', data);
export const getFormDentEndo = (formId) => api.get(`/forms/dent-endo/${formId}`);
export const updateFormDentEndo = (formId, data) => api.patch(`/forms/dent-endo/${formId}`, data);

export const createFormDentExtraction = (data) => api.post('/forms/dent-extraction', data);
export const getFormDentExtraction = (formId) => api.get(`/forms/dent-extraction/${formId}`);
export const updateFormDentExtraction = (formId, data) => api.patch(`/forms/dent-extraction/${formId}`, data);

export const createFormDentProthese = (data) => api.post('/forms/dent-prothese', data);
export const getFormDentProthese = (formId) => api.get(`/forms/dent-prothese/${formId}`);
export const updateFormDentProthese = (formId, data) => api.patch(`/forms/dent-prothese/${formId}`, data);

export const createFormDentParo = (data) => api.post('/forms/dent-paro', data);
export const getFormDentParo = (formId) => api.get(`/forms/dent-paro/${formId}`);
export const updateFormDentParo = (formId, data) => api.patch(`/forms/dent-paro/${formId}`, data);

export const createFormDentPlan = (data) => api.post('/forms/dent-plan', data);
export const getFormDentPlan = (formId) => api.get(`/forms/dent-plan/${formId}`);
export const updateFormDentPlan = (formId, data) => api.patch(`/forms/dent-plan/${formId}`, data);

// Form Data CRUD - form_cs_rd (legacy rheumatology)
