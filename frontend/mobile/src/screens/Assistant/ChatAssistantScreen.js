...
const SUGGESTED_PROMPTS = [
  'Signes d\'une parodontite avancée ?',
...
export default function ChatAssistantScreen({ navigation, route }) {
  ...
  const listData = messages.length > 0 ? messages : [
    ...
    { id: 'hello', role: 'assistant', text: 'Bonjour, je suis votre assistant DentAI. Posez-moi une question clinique ou demandez un résumé patient.' },
  ];
    ...
    <PhoneShell scroll={false} contentStyle={styles.shellContent}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCopy}>
          <Text style={styles.headerName}>Assistant DentAI</Text>
